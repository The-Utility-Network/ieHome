    ...
    return (
        ...
        >
            <motion.div variants={fadeInUp} className="mb-8">
                ...
                >
                    <span className="font-mono text-sm tracking-widest">CHAPTER {String(index + 1).padStart(2, '0')}</span>
                </div>
            ...
            <motion.div variants={fadeInUp} className="prose prose-invert prose-lg max-w-none">
                {chapter.content.map((paragraph, i) => {
                    ...
                    if (/^(\d+\.|-)/.test(trimmedPara)) {
                        return (
                            <div key={i} className="mb-4 pl-4 border-l-2 border-[#A855F7]/40">
...
export default function DocsPage() {
    const [activeChapter, setActiveChapter] = useState(CHAPTERS[0]?.id || 'introduction');
            ...
            <section className="relative min-h-[60vh] flex items-center justify-center overflow-hidden pt-24">
                ...
                <div className="relative z-10 text-center px-6 max-w-4xl mx-auto">
                    ...
                    <motion.p
                        ...
                        style={{ fontFamily: 'Georgia, serif' }}
                    >
                        A comprehensive guide to our mission, roadmap, and path to 501(c)(3) status
                    </motion.p>
                    ...
                    >
                        <button
                            onClick={() => scrollToChapter(CHAPTERS[0]?.id || 'introduction')}
                            ...
                            <div className="max-h-[calc(100vh-10rem)] overflow-y-auto pr-4">
                                ...
                                <div className="mt-8 p-4 rounded-xl border border-[#A855F7]/30">
                                    ...
                                    <div className="font-bold text-[#A855F7]">
                                        {CHAPTERS.find(c => c.id === activeChapter)?.title || 'Introduction'}
                                    </div>
                                </div>
                            </div>
                        </aside>
                        ...
                        <article className="flex-1 max-w-3xl">
                            ...
                            >
                                ...
                                <p className="text-gray-400 max-w-lg mx-auto leading-relaxed mb-8">
                                    This whitepaper is offered to all who seek to understand and support our mission to advocate for veterans facing invisible enemies.
                                </p>
                                <a
                                    href="/"
