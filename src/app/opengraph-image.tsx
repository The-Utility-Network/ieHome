...
export const alt = 'Invisible Enemies - Veterans Advocacy Through Blockchain';
...
export default async function Image() {
    ...
    const bgData = readFileSync(join(process.cwd(), 'public', 'hero-image.png'));
    const bgBase64 = `data:image/png;base64,${bgData.toString('base64')}`;

    const medallionData = readFileSync(join(process.cwd(), 'public', 'IE.png'));
        ...
        (
            <div style={{
                ...
                <div style={{
                    ...
                    <div style={{ position: 'absolute', inset: 0, border: '2px solid rgba(168,85,247,0.3)', borderRight: 'none', borderRadius: '40px 0 0 40px' }} />
                    ...
                    <div style={{ position: 'relative', display: 'flex', flexDirection: 'column', alignItems: 'flex-end' }}>
                        <div style={{
                            ...
                            <span>VETERANS</span>
                            <span style={{ color: primaryColor }}>ADVOCACY</span>
                ...
                <div style={{
                    ...
                    {/* Glass tint */}
                    <div style={{ position: 'absolute', inset: 0, background: 'rgba(255,255,255,0.05)' }} />
                    <div style={{ position: 'absolute', inset: 0, border: '2px solid rgba(168,85,247,0.3)', borderLeft: 'none', borderRadius: '0 40px 40px 0' }} />
                    ...
                    <div style={{ position: 'relative', display: 'flex', flexDirection: 'column', alignItems: 'flex-start', zIndex: 10 }}>
                        ...
                        <div style={{ marginTop: 40, display: 'flex', flexDirection: 'column', gap: 12, borderLeft: `6px solid ${primaryColor}`, paddingLeft: 30 }}>
                            <span style={{ fontSize: 24, color: '#D1D5DB', letterSpacing: '0.15em', fontWeight: 500, textShadow: '0 2px 10px black' }}>TOXIC EXPOSURE</span>
                            <span style={{ fontSize: 24, color: primaryColor, letterSpacing: '0.15em', fontWeight: 700, textShadow: '0 2px 10px black' }}>ie.theutilityfoundation.org</span>
                        </div>
                    </div>
                </div>

                {/* Center Medallion Ring (Blurred) */}
                <div style={{
                    position: 'absolute',
                    left: 810,
                    top: 240,
                    ...
                    <div style={{ position: 'absolute', inset: 0, background: 'rgba(10,0,30,0.6)' }} />
                </div>
                ...
                <div style={{
                    ...
                    {/* Theme Ring */}
                    <div style={{ position: 'absolute', inset: 0, borderRadius: '50%', border: `4px solid ${primaryColor}`, boxShadow: `0 0 60px ${primaryColor}80`, display: 'flex' }} />

                    <img src={medallionBase64} width={700} height={700} style={{ position: 'relative', width: 700, height: 700, objectFit: 'contain', padding: 40 }} />
                </div>
                ...
                <div style={{ position: 'absolute', left: 40, top: 40, width: 2320, height: 40, overflow: 'hidden', borderRadius: '24px 24px 0 0', display: 'flex', zIndex: 5, boxShadow: 'inset 0 0 10px rgba(255,255,255,0.2)' }}>
                    ...
                    <div style={{ position: 'absolute', inset: 0, background: 'rgba(255,255,255,0.05)' }} />
                    <div style={{ position: 'absolute', inset: 0, border: '2px solid rgba(168,85,247,0.3)', borderBottom: 'none' }} />
                </div>
                {/* GLASS FRAME - BOTTOM */}
                <div style={{ position: 'absolute', left: 40, top: 1180, width: 2320, height: 40, overflow: 'hidden', borderRadius: '0 0 24px 24px', display: 'flex', zIndex: 5, boxShadow: 'inset 0 0 10px rgba(255,255,255,0.2)' }}>
                    ...
                    <div style={{ position: 'absolute', inset: 0, background: 'rgba(255,255,255,0.05)' }} />
                    <div style={{ position: 'absolute', inset: 0, border: '2px solid rgba(168,85,247,0.3)', borderTop: 'none' }} />
                </div>
                {/* GLASS FRAME - LEFT */}
                <div style={{ position: 'absolute', left: 40, top: 80, width: 40, height: 1100, overflow: 'hidden', display: 'flex', zIndex: 5, boxShadow: 'inset 0 0 10px rgba(255,255,255,0.2)' }}>
                    ...
                    <div style={{ position: 'absolute', inset: 0, background: 'rgba(255,255,255,0.05)' }} />
                    <div style={{ position: 'absolute', inset: 0, border: '2px solid rgba(168,85,247,0.3)', borderTop: 'none', borderBottom: 'none' }} />
                </div>
                {/* GLASS FRAME - RIGHT */}
